  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden", position: "relative", backgroundColor: "#0D0D0D", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -55%)", textAlign: "center" }}>
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "14vw", fontWeight: 900, color: "#C4862A", lineHeight: 0.85 }}>1</div>
        <div style={{ fontSize: "1.2vw", fontWeight: 500, letterSpacing: "0.4em", textTransform: "uppercase", color: "#F5F3EF", marginTop: "2vh" }}>
          Day
        </div>
        <p style={{ fontSize: "1.1vw", fontWeight: 300, color: "#8A8A82", marginTop: "3vh" }}>Tomorrow, the forest opens to everyone.</p>
      </div>

      <div style={{ position: "absolute", bottom: "7vh", right: "7vw", fontSize: "0.9vw", color: "#5A5A55", fontFamily: "'DM Mono', monospace" }}>12 / 13</div>
    </div>
  );
}
