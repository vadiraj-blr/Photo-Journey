  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden", position: "relative", backgroundColor: "#0D0D0D", fontFamily: "'DM Sans', sans-serif" }}>
      <img
        ...
        alt="Tiger's eye"
      />
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(13,13,13,0.97) 0%, rgba(13,13,13,0.55) 45%, rgba(13,13,13,0.35) 100%)" }} />
      ...
      <div style={{ position: "absolute", bottom: "14vh", left: "7vw", maxWidth: "70vw" }}>
        ...
        <p style={{ fontSize: "1.5vw", fontWeight: 300, color: "#C9C6C0", lineHeight: 1.6, maxWidth: "42vw" }}>
          A new home for India's wild places is about to open.
        </p>
      </div>

      <div style={{ position: "absolute", bottom: "7vh", right: "7vw", fontSize: "0.9vw", color: "#5A5A55", fontFamily: "'DM Mono', monospace" }}>01 / 13</div>
    </div>
  );
}
