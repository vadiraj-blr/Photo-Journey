export default function Slide09Kuno() {
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden", position: "relative", backgroundColor: "#0A0A0A", fontFamily: "'DM Sans', sans-serif", display: "flex" }}>

      <div style={{ position: "absolute", top: "7vh", left: "7vw", zIndex: 2 }}>
      ...
      <div style={{ position: "absolute", top: "7vh", right: "7vw", fontSize: "0.9vw", color: "#333330", fontFamily: "'DM Mono', monospace", zIndex: 2 }}>10</div>

      <div style={{ width: "50vw", height: "100%", display: "flex", alignItems: "center", paddingLeft: "7vw", position: "relative", zIndex: 2 }}>
        <div style={{ maxWidth: "38vw" }}>
          ...
          <p style={{ fontSize: "1.25vw", fontWeight: 300, color: "#9A9890", marginTop: "3vh", lineHeight: 1.75, maxWidth: "36vw" }}>
            After 70 years of extinction in India, cheetahs were reintroduced to Kuno National Park in 2022 — a project with no historical parallel. The dry deciduous scrub of this Madhya Pradesh reserve now shelters Africa's fastest land animal.
          </p>
          <p style={{ fontSize: "1.25vw", fontWeight: 300, color: "#9A9890", marginTop: "1.5vh", lineHeight: 1.75, maxWidth: "36vw" }}>
      ...
      <div style={{ width: "50vw", height: "100%", position: "relative", overflow: "hidden" }}>
        <img
          ...
          alt="Kuno cheetah"
        />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(10,10,10,0.45) 0%, transparent 40%)" }} />
